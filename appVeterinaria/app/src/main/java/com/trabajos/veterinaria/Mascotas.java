...
public class Mascotas extends AppCompatActivity {
    ...
    int idcliente, idraza, idanimal;
    String nombre, color, genero;
    final String URLAnimal = "http://192.168.18.20/veterinaria/controllers/animal.php";
    final String URLMascota = "http://192.168.18.20/veterinaria/controllers/mascota.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spAnimal.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                if(position>0){
                    ...
                    idanimal = animalSelect.getValue();
        ...
        spRaza.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                Raza razaSelect = raza.get(position);
                idraza= razaSelect.getValue();
            }
